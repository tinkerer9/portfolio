...
- **C:** best for low-level hardware control (I've [used this once](/gh/CollaboKeys/blob/main/src/emulate/helper.c))
...
- **Markdown:** basic text formatting; [this page](/gh/portfolio/blob/main/src/pages/languages.md) is programmed in Markdown
- **Node.JS:** technically an *enviroment*, but used for many of my [backend programs](/gh/CollaboKeys/blob/main/src/server.js)
...
Using GitHub Linguist's [list of programming languages](https://github.com/github-linguist/linguist/blob/main/lib/linguist/languages.yml), here are the languages I've used on [GitHub](/gh) (in order of when I learned them):
